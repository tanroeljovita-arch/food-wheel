  ...
  return (
    <main className="mx-auto grid min-h-screen w-full max-w-[78rem] gap-5 overflow-x-hidden px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
      <div className="grid min-w-0 gap-5">
        ...
        <footer className="rounded-[1.25rem] border border-orange-100/70 bg-white/55 px-4 py-4 text-sm leading-6 text-stone-600 shadow-[0_10px_26px_rgba(68,64,60,0.04)]">
          <p>
            Food Wheel is a simple random restaurant picker using manual options and real Google
            Places results.
          </p>
          <nav className="mt-3 flex flex-wrap gap-x-4 gap-y-2 font-medium text-stone-700" aria-label="Footer links">
            <Link className="hover:text-amber-800" href="/about">About</Link>
            <Link className="hover:text-amber-800" href="/guides">Guides</Link>
            <Link className="hover:text-amber-800" href="/random-restaurant-picker">Random Restaurant Picker</Link>
            <Link className="hover:text-amber-800" href="/what-to-eat-near-me">What to Eat Near Me</Link>
            <Link className="hover:text-amber-800" href="/food-wheel-malaysia">Food Wheel Malaysia</Link>
            <Link className="hover:text-amber-800" href="/makan-wheel-malaysia">Makan Wheel Malaysia</Link>
            <Link className="hover:text-amber-800" href="/privacy">Privacy</Link>
            <Link className="hover:text-amber-800" href="/contact">Contact</Link>
          </nav>
        </footer>
      </div>
    </main>
